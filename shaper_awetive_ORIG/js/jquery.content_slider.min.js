(function (e) {
    ...
    function n(n, i) {
        ...
        this.x_offset = o.left;
        this.y_offset = o.top;
        o = this.$parent_wrapper.offset();
        this.parent_x_offset = o.left;
        this.last_c = {
            pos: 0,
            master_click: 1
        };
        ...
        if (this.options.hv_switch == 0) {
            var u = this.math._calculate_child_coordinates_by_n(this.max_show - 1, 0);
            this.max_width = u.new_pos + this.options.left_offset
        } else {
        ...
        e.each(this.$items, function (n, r) {
            s.items[a] = new t(r, e.extend(s.options, {
                $parent: s.$element,
                parent_this: s,
                n: a
            }));
        ...
        if (this.options.hv_switch) this.offset = f.top;
        else this.offset = f.left + this.minus; if (this.options.hv_switch) this._set_text_div_width_ver();
    ...
    t.prototype = {
        ...
        _set_pos_size: function (e, t, n, r, i, s, o, u) {
            var a;
            var f = this.options.border_color;
            ...
            if (!o) {
                if (this.options.border_radius == -1) a = r;
                    ...
                    if (this.options.radius_proportion) {
                        var l = this.options.big_pic_width / this.options.border_radius;
                        var c = r / l;
                        a = c
                    } else {
        ...
        _mouse_down: function (e) {
            e.preventDefault();
            if (this.options.hv_switch) var t = e.pageY - this.parent_this.y_offset;
            else var t = e.pageX - this.parent_this.x_offset + this.parent_this.minus;
    ...
    n.prototype = {
        ...
        create_html: function () {
            ...
            for (t = this._start; t < this._end; t++) {
                ...
                i += this._create_a_html_for_a_child(n, s.new_pos, r)
            }
            var o = this.options.max_shown_items * this.options.child_div_width;
            ...
            this.$container.on("touchmove", e.proxy(function (t) {
                ...
                var i = n.pageX - r.left + this.minus;
                var s = n.pageY - r.top;
        ...
        _mouse_down: function (e, t) {
            ...
            if (typeof e != "undefined")
                if (typeof e.pageX != "undefined") {
                    if (this.options.hv_switch) var n = e.pageY - this.offset;
                    else var n = e.pageX - this.offset + this.minus
                }
        ...
        _mouse_up: function (e) {
            ...
            if (this.show_mouse_move) {
                ...
                if (Math.abs(this.math.sum_movement) == 0 && !this.was_gone) {
                    this.func = 0;
                    t = 0;
                    if (this.options.hv_switch) var n = this.math._change_master_position_by_x(e.pageY - this.offset);
                    else var n = this.math._change_master_position_by_x(e.pageX - this.offset + this.minus - 0);
                    this.last_c = n;
                    if (n.master_click) {
                        var r = 38;
                        var i = 20;
        ...
        _mouse_move: function (t) {
            ...
            if (typeof t != "undefined")
                if (typeof t.pageX != "undefined") {
                    if (this.options.hv_switch) i = t.pageY - this.offset;
                    else i = t.pageX - this.offset + this.minus;
            ...
            if (typeof t != "undefined")
                if (typeof t.pageX != "undefined") {
                    if (this.options.hv_switch) {
                        ...
                        if (this.minus == 0) {
                            i = t.pageX - this.x_offset + this.minus
                        } else {
        ...
        _create_a_html_for_a_child: function (e, t, n) {
            var r = "";
            if (this.options.activate_border_div) r = '<div class="' + this.options.border_class + '"></div>';
            return '<div class="' + this.options.picture_class + " all_around_circle_" + n + '" style="left: ' + t + 'px;">' + r + '<img src="' + e + '" class="all_around_img_' + n + '" /></div>'
        },
    ...
    r.prototype = {
        ...
        _calculate_arrows_positions: function () {
            ...
            var t = this.mid_elem * this.element_width + Math.ceil(e) + this.left_offset - 1;
            var n = 0;
            ...
            var i = this.mid_elem * this.element_width + this.master_element_width + this.arrow_width + e + this.left_offset + 1;
